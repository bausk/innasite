...
const Head = props => {
  ...
  if (article || single) {
    ...
    const postImage = postMeta.cover.resize.src
    title = `${postMeta.title} | ${config.siteTitle}`
    description = (postNode.content && postNode.content.content) || postNode.description.description
  ...
  if (article) {
    schemaArticle = {
      ...
      dateModified: postNode.createdAt,
      description,
      headline: title,
      inLanguage: 'en',
      url: URL,
